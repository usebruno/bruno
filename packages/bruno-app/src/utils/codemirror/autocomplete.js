...
const STATIC_API_HINTS = {
  ...
  bru: [
    ...
    'bru.runner.hooks',
    'bru.runner.hooks.onCollectionRunStart(callback)',
    'bru.runner.hooks.onCollectionRunEnd(callback)',
    'bru.hooks',
    'bru.hooks.on(pattern, callback)',
    'bru.hooks.onBeforeRequest(callback)',
    'bru.hooks.onAfterResponse(callback)',
    'bru.interpolate(str)',
    'bru.cookies',
    'bru.cookies.jar()',
