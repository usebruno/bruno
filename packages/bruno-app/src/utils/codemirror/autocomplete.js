...
const STATIC_API_HINTS = {
  ...
  bru: [
    ...
    'bru.interpolate(str)',
    'bru.getVarList()',
    'bru.getVarList().get(key)',
    'bru.getVarList().set(key, value)',
    'bru.getVarList().has(key)',
    'bru.getVarList().delete(key)',
    'bru.getVarList().clear()',
    'bru.getVarList().toObject()',
    'bru.getEnvVarList()',
    'bru.getEnvVarList().get(key)',
    'bru.getEnvVarList().set(key, value)',
    'bru.getEnvVarList().has(key)',
    'bru.getEnvVarList().delete(key)',
    'bru.getEnvVarList().clear()',
    'bru.getEnvVarList().toObject()',
    'bru.getGlobalEnvVarList()',
    'bru.getGlobalEnvVarList().get(key)',
    'bru.getGlobalEnvVarList().set(key, value)',
    'bru.getGlobalEnvVarList().has(key)',
    'bru.getGlobalEnvVarList().toObject()',
    'bru.cookies',
