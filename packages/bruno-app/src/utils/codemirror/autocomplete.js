...
const STATIC_API_HINTS = {
  ...
  bru: [
    ...
    'bru.interpolate(str)',
    'bru.variables',
    'bru.variables.get(key)',
    'bru.variables.set(key, value)',
    'bru.variables.has(key)',
    'bru.variables.unset(key)',
    'bru.variables.clear()',
    'bru.variables.toObject()',
    'bru.environment',
    'bru.environment.get(key)',
    'bru.environment.set(key, value)',
    'bru.environment.has(key)',
    'bru.environment.unset(key)',
    'bru.environment.clear()',
    'bru.environment.toObject()',
    'bru.environment.name',
    'bru.globals',
    'bru.globals.get(key)',
    'bru.globals.set(key, value)',
    'bru.globals.has(key)',
