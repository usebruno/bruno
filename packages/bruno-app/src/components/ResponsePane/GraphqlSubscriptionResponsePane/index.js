...
const GraphqlSubscriptionResult = ({ response }) => {
  return <GraphqlSubscriptionMessagesList messages={response.responses || []} />;
};
...
const GraphqlSubscriptionResponsePane = ({ item, collection }) => {
  ...
  const getTabPanel = (tab) => {
    switch (tab) {
      case 'response': {
        return <GraphqlSubscriptionResult response={response} />;
      }
      case 'headers': {
