...
const ExportAllModal = ({ onClose, collection }) => {
  ...
  const handleExport = async () => {
    try {
      ...
      const result = await exportCollectionEnvironments(collection, selectedFormat, filePath);
        ...
        >
          <div className="export-content">
            ...
            <div className="location-input export-modal-location">
              <label htmlFor="export-all-location" className="block font-semibold mt-3">
                Location
              </label>
              <input
                id="export-all-location"
                type="text"
