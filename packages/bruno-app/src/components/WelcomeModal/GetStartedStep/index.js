...
const GetStartedStep = ({ onCreateCollection, onImportCollection, onOpenCollection, onStartRequest }) => {
  ...
  return (
    <StyledWrapper className="step-body">
      ...
      <div className="step-title">{t('WELCOME.YOURE_ALL_SET')}</div>
      <div className="step-description">
        {t('WELCOME.GET_STARTED_DESC')}
      </div>
      ...
      <div className="secondary-actions">
        ...
        <button className="secondary-action" onClick={onStartRequest}>
          ...
          <div>
            <div className="secondary-label">{t('WELCOME.GET_STARTED_REQUEST')}</div>
            <div className="secondary-desc">{t('WELCOME.GET_STARTED_REQUEST_DESC')}</div>
          </div>
        </button>
      </div>
    </StyledWrapper>
