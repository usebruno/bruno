...
import { IconVariable, IconSettings, IconRun, IconFolder, IconDatabase, IconWorld, IconHome, IconFileCode, IconRoute } from '@tabler/icons';
      ...
      case 'guides': {
        return (
          <>
            ...
            <span className="ml-1 tab-name">Guides</span>
          </>
        );
      }
