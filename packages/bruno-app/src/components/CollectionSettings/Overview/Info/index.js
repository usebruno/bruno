        ...
        <div className="grid gap-6">
          ...
          <div className="flex items-start">
            ...
            <div className="ml-4">
              ...
              <div className="mt-1.5 text-muted break-all text-xs">
                {collection.pathname}
              </div>
            </div>
          </div>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-4">
              <div className="font-medium text-sm">Requests</div>
              <div className="mt-1.5 text-muted text-xs">
                {
          ...
          <div className="flex items-start group cursor-pointer" onClick={handleToggleShowShareCollectionModal(true)}>
            ...
            <div className="ml-4 h-full flex flex-col justify-start">
              <div className="font-medium text-sm h-fit my-auto">Share</div>
              <div className="mt-1.5 group-hover:underline text-link text-xs">
                Share Collection
              </div>
            </div>
          </div>
