...
export const TabsTrigger = ({ value: triggerValue, children, className = '' }) => {
  ...
  return (
    <button
      ...
      className={`inline-flex items-center justify-center rounded-[4px] p-[8px] whitespace-nowrap transition-all cursor-pointer border border-transparent hover:opacity-90 ${className}`}
      style={{
