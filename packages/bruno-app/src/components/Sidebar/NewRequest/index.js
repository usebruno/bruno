...
const NewRequest = ({ collectionUid, item, isEphemeral, onClose }) => {
  ...
  const getRequestType = (collectionPresets) => {
    ...
    if (collectionPresets.requestType === 'signalr') {
      return 'signalr-request';
    }
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      id="signalr-request"
                      name="requestType"
                      value="signalr-request"
                      checked={formik.values.requestType === 'signalr-request'}
                      onChange={formik.handleChange}
                      data-testid="signalr-request"
                    />
                    <label htmlFor="signalr-request" className="ml-1 cursor-pointer select-none">
                      SignalR
                    </label>
                  </div>
                  <div className="flex items-center gap-2">
              ...
              <>
                <div className="mt-4">
                  ...
                  <div className="flex items-center mt-2 ">
                    {!['grpc-request', 'ws-request', 'signalr-request'].includes(formik.values.requestType) ? (
