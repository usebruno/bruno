...
import RemoveCollectionsModal from 'components/Sidebar/Collections/RemoveCollectionsModal';
  ...
  return (
    <>
      ...
      {collectionUidsToRemove.length > 0 && (
        <RemoveCollectionsModal collectionUids={collectionUidsToRemove} onClose={() => setCollectionUidsToRemove([])} />
      )}
