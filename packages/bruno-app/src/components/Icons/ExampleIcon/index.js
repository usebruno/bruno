  ...
  return (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <g clipPath="url(#clip0_486_1191)">
        ...
        <path d="M9.33366 5.33337H6.66699V10.6667H9.33366" stroke={color} stroke-width="1" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M9.33366 8H6.66699" stroke={color} stroke-width="1" stroke-linecap="round" stroke-linejoin="round" />
      </g>
      <defs>
