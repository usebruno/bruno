...
import { exportGlobalEnvironmentAsBru, exportGlobalEnvironmentAsJson } from 'utils/exporters/environments/environment-export';
  ...
  const handleExport = async () => {
    try {
      ...
      if (selectedFormat === 'bru') {
        result = await exportGlobalEnvironmentAsBru(environment, filePath);
      } else if (selectedFormat === 'json') {
        result = await exportGlobalEnvironmentAsJson(environment, filePath);
      }
