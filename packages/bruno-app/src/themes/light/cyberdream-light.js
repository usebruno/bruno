// Cyberdream Theme for Bruno (light)
...
const cyberdreamLightTheme = {
  ...
  status: {
    info: {
      background: rgba(palette.intent.INFO, 0.12),
      text: palette.intent.INFO,
      border: palette.intent.INFO
    },
    success: {
      background: rgba(palette.intent.SUCCESS, 0.12),
      text: palette.intent.SUCCESS,
      border: palette.intent.SUCCESS
    },
    warning: {
      background: rgba(palette.intent.WARNING, 0.12),
      text: palette.intent.WARNING,
      border: palette.intent.WARNING
    },
    danger: {
      background: rgba(palette.intent.DANGER, 0.12),
  ...
  dropdown: {
    ...
    bg: colors.BG,
    hoverBg: colors.BG_ALT,
    shadow: '0 2px 8px rgba(0, 0, 0, 0.14), 0 0 0 1px rgba(0, 0, 0, 0.06)',
    border: colors.BORDER1,
    separator: colors.BORDER0,
  ...
  requestTabPanel: {
    url: {
      ...
      border: `solid 1px ${colors.BORDER0}`
    },
    dragbar: {
      border: colors.BORDER1,
  ...
  codemirror: {
    ...
    searchLineHighlightCurrent: rgba(colors.CYAN, 0.12),
  ...
  app: {
    collection: {
      toolbar: {
        ...
        sandboxMode: {
          safeMode: {
            bg: rgba(colors.GREEN, 0.1),
            color: colors.GREEN
          },
          developerMode: {
            bg: rgba(colors.ORANGE, 0.1),
            color: colors.ORANGE
          }
        }
      }
...
export default cyberdreamLightTheme;
