...
// bg ladder the app's BASE sits, then layers SURFACE0/1/2 above and
// MANTLE/CRUST below it. Soft shifts the whole surface stack up by one rung
// so SURFACE0 never collides with the soft BASE (#32302f).
...
const createGruvboxDarkTheme = (variant) => {
...
export const gruvboxDarkSoft = createGruvboxDarkTheme('soft');
export const gruvboxDarkMedium = createGruvboxDarkTheme('medium');
export const gruvboxDarkHard = createGruvboxDarkTheme('hard');
