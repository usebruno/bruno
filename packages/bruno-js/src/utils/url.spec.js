...
describe('parseUrl', () => {
  it.each([
    ...
    { url: 'https://example.com/path#section?a=1', host: 'example.com', path: '/path' },
    { url: 'https://example.com?test=a:b = c', host: 'example.com', path: '/', query: 'test=a:b = c' },
    { url: 'https://example.com/path?test=a%3Ab%20%3D%20c', host: 'example.com', path: '/path', query: 'test=a%3Ab%20%3D%20c' },
