 ...
 * stale recipe is only ever slower, never wrong. They are generated by the package's prepare step, so
 * a plain `npm install` produces them; `npm run generate:grammars` refreshes them by hand, and
...
// Build output, not source: generated by the package's prepare step and git-ignored.
