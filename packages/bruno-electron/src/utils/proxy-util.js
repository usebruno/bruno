...
function createTimelineAgentClass(BaseAgentClass) {
  return class extends BaseAgentClass {
    ...
    createConnection(options, callback) {
      ...
      const bundledCerts = this.caCertificateDetails.bundled;
      const systemCerts = this.caCertificateDetails.system;
      const extraCerts = this.caCertificateDetails.extra;
      const customCerts = this.caCertificateDetails.custom;
