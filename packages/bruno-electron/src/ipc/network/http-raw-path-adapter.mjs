...
import {progressEventReducer, progressEventDecorator, asyncDecorator} from 'axios/unsafe/helpers/progressEventReducer.js';
...
export default isHttpAdapterSupported && function httpAdapter(config) {
  return wrapAsync(async function dispatchHttpRequest(resolve, reject, onDone) {
    ...
    try {
      const pathSource = rawPath || (parsed.pathname + parsed.search);
