...
const simpleTranslations = {
  ...
  'req.headerList.idx': 'pm.request.headers.idx',
  ...
  'req.headerList.prepend': 'pm.request.headers.prepend',
  'req.headerList.append': 'pm.request.headers.append',
  'req.headerList.insert': 'pm.request.headers.insert',
  'req.headerList.insertAfter': 'pm.request.headers.insertAfter',
  ...
  'res.headerList.idx': 'pm.response.headers.idx',
