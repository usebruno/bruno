...
describe('Request Translation', () => {
  ...
  it('should handle request data extraction and variable setting', () => {
    ...
    expect(translatedCode).toContain('bru.getVarList().set("lastRequestBody", JSON.stringify(requestData));');
    expect(translatedCode).toContain('bru.getEnvVarList().set("lastContentType", contentType);');
  });
