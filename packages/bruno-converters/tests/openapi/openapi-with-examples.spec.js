...
describe('OpenAPI with Examples', () => {
  ...
  it('should import OpenAPI collection with response examples', () => {
    ...
    expect(emptyExample.response.status).toHaveText(/200/);
    ...
    expect(validationErrorExample.response.status).toHaveText(/400/);
    ...
    expect(serverErrorExample.response.status).toHaveText(/500/);
    ...
    expect(createdExample.response.status).toHaveText(/201/);
...
`;
      ...
      expect(createdWithValid.response.status).toHaveText(/201/);
      ...
      expect(createdWithInvalid.response.status).toHaveText(/201/);
