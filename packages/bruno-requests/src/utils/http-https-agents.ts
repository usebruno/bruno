...
const getCertsAndProxyConfig = ({
  ...
  const collectionProxyConfig = collectionLevelProxy || {} as ProxyConfig;
  ...
  if (collectionProxyEnabled === true) {
    ...
    // proxyConfig = systemProxyConfig || {} as ProxyConfig;
    proxyMode = get(proxyConfig, 'mode', 'off') as ProxyMode;
  }
