...
test('Verify cross-collection request drag and drop, a duplicate request exist. expected to rename the dropped request', async ({ pageWithUserData: page, createTmpDir }) => {
