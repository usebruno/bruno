...
test.describe('Collection environment inheritance, authored in the app', () => {
  ...
  test('an inherited variable is read-only in the variable tooltip, and goes to definition in the environment it came from', async ({
    page,
    createTmpDir
  }) => {
    ...
    await test.step('The tooltip shows the inherited variable as read-only', async () => {
