...
test.describe('Global Environments - Export Individual', () => {
  test('should export individual global environment as JSON and validate from file', async ({ pageWithUserData: page }) => {
    ...
    expect(parsed).toHaveProperty('name', 'Test Environment 1');
