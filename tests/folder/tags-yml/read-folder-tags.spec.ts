...
/**
 * The yml mirror of `tests/folder/tags`. Folder tags live in `info.tags` of folder.yml rather than
 * `meta.tags` of folder.bru. The tree is identical:
 *
 *   untagged                  -> []
 ...
 *     plain                   -> []
 */
test.describe('Folder Tags (YAML) — inheritance display', () => {
  test('reads a folder\'s own tags from folder.yml into the Settings tab', async ({ pageWithUserData: page }) => {
