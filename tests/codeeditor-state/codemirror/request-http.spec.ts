...
import { buildCommonLocators, closeAllCollections, LINK_AWARE_COLLECTION_NAME as COLLECTION_NAME, expectLinkOpensRequest, expectNoLink, openCollectionFromDialog, openRequest, selectRequestPaneTab, selectScriptSubTab, setCodeMirrorValue as setCmValue } from '../../utils/page';
...
test.describe('CodeMirror link-aware - HTTP request tab', () => {
  ...
  test('URL Bar: link-awareness is fully disabled (no mark at all)', async ({ page }) => {
