...
// gRPC TLS. The server rejects the connection at the handshake and the call fails with a
// non-OK status.
test.describe('grpc with collection client certificate (disabled, yml)', () => {
