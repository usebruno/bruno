    ...
    <StyledWrapper>
      ...
      <form onSubmit={formik.handleSubmit}>
        <div className="flex justify-center flex-col form-container mx-auto mt-10 p-5">
          ...
          <div>
            <label htmlFor="name" className="pb-2 pt-3 block font-semibold">Name</label>
            ...
            {formik.touched.name && formik.errors.name ? (
              <div className="field-error error-msg">{formik.errors.name}</div>
            ) : null}
          </div>

          <div>
            <label htmlFor="email-address" className="pb-2 pt-4 block font-semibold">Email address</label>
